...
<div class="services">
    ...
    <ServiceCard
        ...
        description="Visuelle Gestaltung digitaler Produkte"
        --icon-color="#6AEDAC">
        <svelte:fragment slot="icon">
            ...
            <g id="Group_4593" data-name="Group 4593" transform="translate(-589 -9426)">
                ...
                <g id="Icon-2" class="icon" data-name="Icon" transform="translate(9.864 3.967)">
    ...
    <ServiceCard
        ...
        description="Nutzerzentrierte Produktentwicklung"
        --icon-color="#6AEDAC">
        <svelte:fragment slot="icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="47" viewBox="0 0 50 47">
            <g id="Group_4594" data-name="Group 4594" transform="translate(-814 -9426)">
                ...
                <g id="Icon-2" class="icon" data-name="Icon" transform="translate(5.918 3.967)">
    ...
    <ServiceCard
        title="Software"
        description="Entwicklung und Beratung"
        --icon-color="#bb9ab3">
        <svelte:fragment slot="icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="52" height="47.468" viewBox="0 0 52 47.468">
            <g id="Group_4595" data-name="Group 4595" transform="translate(-1043 -9426)">
                <ellipse id="Ellipse_803" data-name="Ellipse 803" cx="13.5" cy="13" rx="13.5" ry="13" transform="translate(1043 9447)" fill="#bb9ab3" opacity="1"/>
    ...
    <ServiceCard
        title="Motion Design"
        description="Markengeschichten erzählen"
        --icon-color="#F97A7A">
        <svelte:fragment slot="icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="54.133" height="47" viewBox="0 0 54.133 47">
    ...
    <ServiceCard
        title="Branding"
        description="Aufbau der Marke"
        --icon-color="#8AA5FD">
        <svelte:fragment slot="icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="52" height="47.401" viewBox="0 0 52 47.401">
    ...
    <ServiceCard
        ...
        description="Visueller Auftritt der Marke"
        --icon-color="#8AA5FD">
        <svelte:fragment slot="icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="47" viewBox="0 0 50 47">
    ...
    <ServiceCard
        title="Webdesign"
        description="Onlineauftritt der Marke"
        --icon-color="#8AA5FD">
        <svelte:fragment slot="icon">
    ...
    <ServiceCard
        title="Illustration"
        description="Visuelle Welten aufbauen"
        --icon-color="#8AA5FD">
        <svelte:fragment slot="icon">
...
<style lang="scss">
    .services {
        ...
        column-gap: var(--g-comp-grid-col-gap);
        row-gap: 1.25rem;
